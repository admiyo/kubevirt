...
func (_m *MockVMService) FetchVM(vmName string, namespace string) (*v10.VM, bool, error) {
	ret := _m.ctrl.Call(_m, "FetchVM", vmName, namespace)
	ret0, _ := ret[0].(*v10.VM)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
...
func (_m *MockVMService) FetchMigration(migrationName string, namespace string) (*v10.Migration, bool, error) {
	ret := _m.ctrl.Call(_m, "FetchMigration", migrationName, namespace)
