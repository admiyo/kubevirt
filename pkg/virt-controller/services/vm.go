...
func (v *vmService) FetchVM(vmName string, namespace string) (*corev1.VM, bool, error) {
...
func (v *vmService) FetchMigration(migrationName string, namespace string) (*corev1.Migration, bool, error) {
